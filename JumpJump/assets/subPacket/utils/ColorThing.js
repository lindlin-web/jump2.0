...
cc.Class({
    ...
    onLoad() {
        this.testCount = 0;
        if(this.testLabel) {
            this.testLabel.string = "onLoadonLoadononLoadonLoadonLoad";
        }
    },

    start() {
        if(this.testLabel) {
            ///this.testLabel.string = "startstartstartstartstartstartstart";
        }
    },
    ...
    update() {
        if(this.testLabel) {
            this.testCount++;
            this.testLabel.string = "onLoadonLoadonLoadonLoadonLoadonLoad" + this.testCount;
        }
    },
